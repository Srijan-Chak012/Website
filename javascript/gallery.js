...
function change_image() 
{
    ...
    {
        x.src = "../img/gallery/Display_2.jpeg";
    } 

    else if (str.includes("Display_2.jpeg")) 
    {
        x.src = "../img/gallery/Display_3.jpeg";
    } 

    else if (str.includes("Display_3.jpeg")) {
        x.src = "../img/gallery/Display_4.jpeg";
    } 
    
    else if (str.includes("Display_4.jpeg")) 
    {
        x.src = "../img/gallery/Display_5.jpeg";
    } 
    
    else if (str.includes("Display_5.jpeg")) {
        x.src = "../img/gallery/Display_1.jpeg";
    } 
